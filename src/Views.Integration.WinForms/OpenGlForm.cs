namespace GLHDN.Views.Integration.WinForms
{
    ...
    public sealed class OpenGlForm : Form, IUiContext
    {
        ...
        public OpenGlForm(Views.View view, Action<TimeSpan> modelUpdateHandler, bool lockCursor)
        {
            this.SuspendLayout();
            ...
            this.GlControl.Resize += (s, a) => view.Resize(((GlControl)s).Width, ((GlControl)s).Height);
